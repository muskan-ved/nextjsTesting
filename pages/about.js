      ...
      <div class="col-xl-3 col-sm-6 mb-5">
        <div class="bg-white rounded shadow-sm py-5 px-4"><img src="https://bootstrapious.com/i/snippets/sn-about/avatar-4.png" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"/>
          ...
          <ul class="social mb-0 list-inline mt-3">
            <li class="list-inline-item"><a href="#" class={style.sociallink}><i class="fa fa-facebook-f"></i></a></li>
            <li class="list-inline-item"><a href="#" class={style.sociallink}><i class="fa fa-twitter"></i></a></li>
            <li class="list-inline-item"><a href="#" class={style.sociallink}><i class="fa fa-instagram"></i></a></li>
            <li class="list-inline-item"><a href="#" class={style.sociallink}><i class="fa fa-linkedin"></i></a></li>
          </ul>
        </div>
      </div>
